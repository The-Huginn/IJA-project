...
public class ClassDiagramUndoTest {
    ...
    public void addClassTest() {
        ...
        assertTrue(diagram.getClasses().get(0) == class1);
        assertTrue(diagram.getClasses().get(1) == class2);
        ...
        assertTrue(diagram.getClasses().size() == 0);
    }
    ...
    public void removeClassTest() {
        ...
        assertTrue(diagram.getClasses().size() == 1);
        assertTrue(diagram.getClasses().get(0) == class2);

        diagram.undo();

        assertTrue(diagram.getClasses().size() == 2);
        assertTrue(diagram.getClasses().get(0) == class2);
        assertTrue(diagram.getClasses().get(1) == class3);

        diagram.undo();
        assertTrue(diagram.getClasses().size() == 3);
        assertTrue(diagram.getClasses().get(0) == class1);
        assertTrue(diagram.getClasses().get(1) == class2);
        assertTrue(diagram.getClasses().get(2) == class3);
    }
    ...
    public void addInterfaceTest() {
        ...
        assertTrue(diagram.getInterfaces().size() == 2);
        assertTrue(diagram.getInterfaces().get(0) == umlInterface1);
        assertTrue(diagram.getInterfaces().get(1) == umlInterface2);

        diagram.undo();

        assertTrue(diagram.getInterfaces().size() == 1);
        assertTrue(diagram.getInterfaces().get(0) == umlInterface1);

        diagram.undo();

        assertTrue(diagram.getInterfaces().size() == 0);
    }
    ...
    public void removeInterfaceTest() {
        ...
        assertTrue(diagram.getInterfaces().size() == 1);
        assertTrue(diagram.getInterfaces().get(0) == umlInterface2);

        diagram.undo();

        assertTrue(diagram.getInterfaces().size() == 2);
        assertTrue(diagram.getInterfaces().get(0) == umlInterface2);
        assertTrue(diagram.getInterfaces().get(1) == umlInterface3);

        diagram.undo();
        assertTrue(diagram.getInterfaces().size() == 3);
        assertTrue(diagram.getInterfaces().get(0) == umlInterface1);
        assertTrue(diagram.getInterfaces().get(1) == umlInterface2);
        assertTrue(diagram.getInterfaces().get(2) == umlInterface3);
    }
    ...
    public void addDiagramTest() {
        ...
        assertTrue(diagram.getDiagrams().size() == 2);
        assertTrue(diagram.getDiagrams().get(0) == seqDiagram1);
        assertTrue(diagram.getDiagrams().get(1) == seqDiagram2);

        diagram.undo();

        assertTrue(diagram.getDiagrams().size() == 1);
        assertTrue(diagram.getDiagrams().get(0) == seqDiagram1);

        diagram.undo();

        assertTrue(diagram.getDiagrams().size() == 0);
    }
    ...
    public void removeDiagramTest() {
        ...
        assertTrue(diagram.getDiagrams().size() == 1);
        assertTrue(diagram.getDiagrams().get(0) == seqDiagram2);

        diagram.undo();

        assertTrue(diagram.getDiagrams().size() == 2);
        assertTrue(diagram.getDiagrams().get(0) == seqDiagram2);
        assertTrue(diagram.getDiagrams().get(1) == seqDiagram3);

        diagram.undo();
        assertTrue(diagram.getDiagrams().size() == 3);
        assertTrue(diagram.getDiagrams().get(0) == seqDiagram1);
        assertTrue(diagram.getDiagrams().get(1) == seqDiagram2);
        assertTrue(diagram.getDiagrams().get(2) == seqDiagram3);
    }
