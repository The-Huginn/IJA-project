...
public class SeqDiagramUndoTest {
    ...
    public void addInstanceTest() {
        ...
        Assert.assertTrue(diagram.getInstances().get(0).getKey() == umlClass1);
        Assert.assertTrue(diagram.getInstances().get(1).getKey() == umlClass2);
    ...
    public void removeInstanceTest() {
        ...
        Assert.assertTrue(diagram.getInstances().size() == 1);
        Assert.assertTrue(diagram.getInstances().get(0).getKey() == umlClass2);

        diagram.undo();

        Assert.assertTrue(diagram.getInstances().size() == 2);
        Assert.assertTrue(diagram.getInstances().get(0).getKey() == umlClass2);
        Assert.assertTrue(diagram.getInstances().get(1).getKey() == umlClass1 && diagram.getInstances().get(1).getValue() == 1);

        diagram.undo();

        Assert.assertTrue(diagram.getInstances().size() == 3);
        Assert.assertTrue(diagram.getInstances().get(0).getKey() == umlClass1 && diagram.getInstances().get(0).getValue() == 0);
        Assert.assertTrue(diagram.getInstances().get(1).getKey() == umlClass2);
        Assert.assertTrue(diagram.getInstances().get(2).getKey() == umlClass1 && diagram.getInstances().get(2).getValue() == 1);
    }
